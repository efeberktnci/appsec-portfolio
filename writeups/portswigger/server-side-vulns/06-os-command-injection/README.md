# OS command injection — Index (PortSwigger)
...
![Topic: os-command-injection](https://img.shields.io/badge/Topic-os--command--injection-3B5BDB?style=for-the-badge)
![Last update](https://img.shields.io/badge/Last%20update-2026--05--16-495057?style=for-the-badge)

## Labs
- [Lab: OS command injection, simple case](01-lab-os-command-injection-simple-case.md)
